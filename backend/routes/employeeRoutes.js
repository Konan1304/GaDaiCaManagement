...
router.patch("/branches/:id",controller.updateBranchInfo);
router.delete("/branches/:id",allowRoles("admin"),controller.deleteBranch);
...
router.post("/schedule-registration-periods/all",allowRoles("admin"),normalizeRegistrationTimes,registration.validateCreateAllPeriods,registration.createAllPeriods);
...
router.post("/employees/:id/avatar",allowRoles("admin"),uploadAvatar.single("avatar"),controller.updateAvatar);
...
router.patch("/employees/:id/profile-update-lock",controller.profileUpdateLock);
