...
(async()=>{
  ...
  try{
    ...
    try{
      const tables=["chat_read_states","notifications","chat_messages","operation_attachments","shift_handovers","shift_report_versions","shift_cash_counts","shift_cash_denominations","shift_closing_reports","business_events","shift_operation_audit_logs","operation_shift_assignments","payrolls","attendance_logs","shift_expenses","payments","order_items","orders","shift_sessions","inventory_transactions","purchase_receipt_items","purchase_receipts","schedule_draft_assignments","employee_shift_registrations","employee_schedules","schedule_registration_periods","leave_requests"];
