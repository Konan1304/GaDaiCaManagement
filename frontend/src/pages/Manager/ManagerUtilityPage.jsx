...
export default function ManagerUtilityPage({ type }) {
  ...
  if(type === "settings") return <section className="card list-card utility-page"><div className="section-title"><div><h2>Cài đặt</h2><p>Cấu hình thông tin cửa hàng.</p></div><FiSettings/></div><form className="settings-form"><label>Tên cửa hàng<input defaultValue="Gà Đại Ca - Chi nhánh Quận 1"/></label><label>Số điện thoại<input defaultValue="028 3822 2026"/></label><label>Địa chỉ<input defaultValue="125 Nguyễn Huệ, Quận 1, TP.HCM"/></label><button type="button" className="btn btn-primary"><FiSave/> Lưu thay đổi</button></form></section>;
